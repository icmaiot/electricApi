...
module.exports = {
    get: async function (req, res) {
        try {
            ...
            let response = await Raw.findAll({
                attributes: ['idraw', 'desc_raw'],
                where: query,
                include: [{
                    model: Um,
                    required: false,
    ...
    create: async function (req, res) {
        try {
            let response_new = new Raw(req.body);
    ...
    delete: async function (req, res) {
        try {
            const response = await Raw.destroy({
                where: { idraw: req.params.id }
            })
    ...
    update: async function (req, res) {
        try {
            const resp = await Raw.update(req.body, {
                where: { idraw: req.params.id }
            })
