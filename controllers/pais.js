...
module.exports = {
    ...
    create: async function (req, res) {
        try {
            let response_new = new Pais(req.body);
    ...
    delete: async function (req, res) {
        try {
            const response = await Pais.destroy({
    ...
    update: async function (req, res) {
        try {
            const resp = await Pais.update(req.body, {
                where: { idrelcomercial: req.params.id }
            })
    ...
    read: async function (req, res) {
        try {
            let response = await Pais.findOne({
                where: { idrelcomercial: req.params.id }
            });
            if (response) {
