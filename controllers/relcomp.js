...
module.exports = {
    get: async function (req, res) {
        try {
            let response = await Relcomp.findAll({
    ...
    create: async function (req, res) {
        try {
            let response_new = new Relcomp(req.body);
    ...
    delete: async function (req, res) {
        try {
            const response = await Relcomp.destroy({
    ...
    update: async function (req, res) {
        try {
            const resp = await Relcomp.update(req.body, {
                where: { idrelcomercial: req.params.id }
            })
    ...
    read: async function (req, res) {
        try {
            let response = await Relcomp.findOne({
                where: { idrelcomercial: req.params.id }
            });
            if (response) {
