...
module.exports = {
    get: async function (req, res) {
        try {
            ...
            let response = await Registrodefectos.findAll({
                attributes: ['iddefreg', 'descripcion_defecto', 'cod_defecto'],
                where: query,
            })
            if (response) {
    ...
    create: async function (req, res) {
        try {
            let response_new = new Registrodefectos(req.body);
    ...
    delete: async function (req, res) {
        try {
            const response = await Registrodefectos.destroy({
                where: { iddefreg: req.params.id }
            })
    ...
    update: async function (req, res) {
        try {
            const resp = await Registrodefectos.update(req.body, {
                where: { iddefreg: req.params.id }
            })
